        ...
        if char == "CE": 
            ...
            try: 
                ...
                safe_dict = {
                    ...
                    "cosec": lambda x: 1/sin(radians(x)),  
                    "sec": lambda x: 1/cos(radians(x)), 
                    "cot": lambda x: 1/tan(radians(x)),  
                    "mod": fmod, 
                    "e": e,
                    "pow": pow
                }
...
if __name__ == "__main__": 
    try:
        ...
        print(f"GUI Error: {e}")
        print("This program requires a graphical display environment to run.")
        print("Make sure you're running it on a system with a GUI or proper display forwarding.")
